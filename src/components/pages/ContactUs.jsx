        ...
        <div className="flex flex-col m-auto justify-center items-center h-auto sm:px-4 md:px-20 md:py-4 2xl:px-[350px]">
          <div className="flex flex-col justify-center items-center w-auto h-auto px-4 py-4 md:px-20 md:py-4 xl:px-[165px] 2xl:px-[340px] gap-5">
            <div className="flex flex-col gap-5">
              <h1 className="text-black text-4xl font-semibold font-work-sans dark:text-gray-night-950 ">
                Contact Us
              </h1>
              <h1 className="text-[var(--secondary-500)] font-work-sans dark:text-gray-night-600 text-base font-normal">
            ...
            <div className="flex w-auto h-auto justify-between gap-4 md:gap-[50px] py-[10px]">
              <div className="flex flex-col w-auto h-auto p-4 rounded-xl border border-solid border-[#E8E8EA]">
                <h1 className="text-black dark:text-gray-night-600  text-2xl font-semibold font-work-sans">
                  Address
                </h1>
                <h1 className="text-[var(--secondary-500)] dark:text-gray-night-500  text-lg font-normal">
          ...
          <div className="flex flex-col w-auto h-auto bg-[var(--secondary-50)] dark:bg-gray-night-100 px-4 py-4 md:pt-[29px] md:pr-[130px] md:pb-[26px] md:pl-[35px] gap-6">
            <h1 className="text-black dark:text-gray-night-950  font-work-sans text-lg font-semibold">
              Leave a Message
            </h1>
